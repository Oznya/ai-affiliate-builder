// Facebook OAuth Callback - Fixed version with page selection
export async function onRequestGet(context) {
  ...
  try {
    ...
    return new Response(getSelectionHtml(pages, siteId, productName || 'Produit'), {
...
function getSelectionHtml(pages, siteId, productName) {
...
<body>
  <div class="container">
    ...
    <p class="subtitle">Choisissez la Page pour la publication automatique</p>
  ...
  <script>
    ...
    pagesData.forEach((page, index) => {
      ...
      btn.innerHTML = '<img src="' + (page.picture?.data?.url || 'https://via.placeholder.com/50') + '" alt="' + page.name + '"><div><div class="page-name">' + page.name + '</div><div class="page-category">' + (page.category || '') + '</div></div>';
      btn.onclick = function() { selectPage(index); };
